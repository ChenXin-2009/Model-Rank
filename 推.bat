...
if not defined REMOTE_URL (
    echo ⚠️  未配置远程仓库（git remote origin），推送前请先:
    echo      git remote add origin https://github.com/你的用户名/model-rank.git
    echo.
)
...
REM 生成 GitHub Release 链接
if defined REMOTE_URL (
    set REPO_PATH=!REMOTE_URL!
    ...
    echo    https://github.com/!REPO_PATH!/releases/new?tag=v!NEW_VERSION!
)
echo.
echo 💡 提示: 你可以到 GitHub Actions 查看每日数据刷新（.github/workflows/refresh.yml）
echo.
pause